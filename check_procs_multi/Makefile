...
#     NO_META => q[1]
#     PREREQ_PM => { Nagios::Plugin=>q[0], Getopt::Long=>q[0], English=>q[0], version=>q[0], Nagios::Plugin::Threshold=>q[0], Carp=>q[0] }
#     VERSION => q[0.9.5]
...
SITEARCHEXP = /usr/lib/perl5/site_perl/5.10.0/i386-linux-thread-multi
SO = so
...
INSTALLSITEARCH = /usr/lib/perl5/site_perl/5.10.0/i386-linux-thread-multi
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = check_procs_multi.pod
...
TO_INST_PM = check_procs_multi.pod

PM_TO_BLIB = check_procs_multi.pod \
	$(INST_LIB)/check_procs_multi.pod
...
DISTVNAME = check_procs_multi-0.9.5
...
manifypods : pure_all  \
	check_procs_multi.pod
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  check_procs_multi.pod $(INST_MAN3DIR)/check_procs_multi.$(MAN3EXT) 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  check_procs_multi.pod $(INST_LIB)/check_procs_multi.pod 
