...
DISTVNAME = check_free_mem-0.11.2
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  check_free_mem $(INST_MAN1DIR)/check_free_mem.$(MAN1EXT) 
...
ppd:
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,11,2,0">' > $(DISTNAME).ppd
