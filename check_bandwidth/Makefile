...
#     NO_META => q[1]
#     PREREQ_PM => { Net::DNS::Resolver=>q[0], Nagios::Plugin=>q[0], Getopt::Long=>q[0], English=>q[0], version=>q[0], ExtUtils::MakeMaker=>q[6.42], Carp=>q[0], Nagios::Plugin::Threshold=>q[0] }
#     VERSION => q[0.9.6]
