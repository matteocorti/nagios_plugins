...
# 6.38 (Revision: 40911) from the contents of
...
#     NO_META => q[1]
#     PREREQ_PM => { Nagios::Plugin=>q[0], Getopt::Long=>q[0], English=>q[0], version=>q[0], Nagios::Plugin::Threshold=>q[0], File::Slurp=>q[0], Carp=>q[0] }
#     VERSION => q[1.0.0]
...
DISTVNAME = check_free_mem-1.0.0
